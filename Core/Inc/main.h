...
#define LED4A6_Pin GPIO_PIN_6
#define LED4A6_GPIO_Port GPIOA
...
#define PLUS_PORT   GPIOB
#define PLUS_PIN    GPIO_PIN_15
#define REDUCE_PORT GPIOB
#define REDUCE_PIN  GPIO_PIN_13
#define SOS_PORT    GPIOB
#define SOS_PIN     GPIO_PIN_12
#define HORN_PORT   GPIOB
