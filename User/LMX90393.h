...
static uint8_t mem_map_buffer;
static float multiplier_x;
static float multiplier_y;
static float multiplier_z;

static struct MLX_data{
...
static calib_set gui_settings;
static calib_set slave_settings;

#define OK 		true
#define NOT_OK	false
typedef bool RetStatus;

static enum configuration_states
{
	WAIT_FOR_GUI,
	READ_VM_MEMORY,
	WRITE_NVM_MEMORY,
