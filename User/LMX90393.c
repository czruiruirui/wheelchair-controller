...
{
	HAL_I2C_Mem_Read(&hi2c2, MLX90393_ADDR, CMD_START_SINGLE | X_AXIS_MASK, 1, buffer, 1, HAL_MAX_DELAY);	// single measurement mode
	HAL_I2C_Mem_Read(&hi2c2, MLX90393_ADDR, CMD_READ_MEASUREMENT | X_AXIS_MASK, 1, buffer, 3, HAL_MAX_DELAY);
...
{
	HAL_I2C_Mem_Read(&hi2c2, MLX90393_ADDR, CMD_START_SINGLE | Y_AXIS_MASK, 1, buffer, 1, HAL_MAX_DELAY);
	HAL_I2C_Mem_Read(&hi2c2, MLX90393_ADDR, CMD_READ_MEASUREMENT | Y_AXIS_MASK, 1, buffer, 3, HAL_MAX_DELAY);
...
{
	HAL_I2C_Mem_Read(&hi2c2, MLX90393_ADDR, CMD_START_SINGLE | Z_AXIS_MASK, 1, buffer, 1, HAL_MAX_DELAY);
	HAL_I2C_Mem_Read(&hi2c2, MLX90393_ADDR, CMD_READ_MEASUREMENT | Z_AXIS_MASK, 1, buffer, 3, HAL_MAX_DELAY);
...
{
	HAL_I2C_Mem_Read(&hi2c2, MLX90393_ADDR, CMD_START_SINGLE | X_AXIS_MASK, 1, buffer, 1, HAL_MAX_DELAY);
}
...
uint8_t get_resolution_X(void)					// get resolution of X axis
{
	uint8_t buffer[3];
	uint16_t value;
	HAL_I2C_Mem_Read(&hi2c2, MLX90393_ADDR, (CMD_READ_REGISTER << 8) | (REG_02 << 2), 2, buffer, sizeof(buffer), HAL_MAX_DELAY); // read whole register
	HAL_I2C_Mem_Read(&hi2c2, MLX90393_ADDR, (CMD_READ_REGISTER << 8) | (REG_02 << 2), 2, buffer, sizeof(buffer), HAL_MAX_DELAY);
	HAL_I2C_Mem_Read(&hi2c2, MLX90393_ADDR, (CMD_READ_REGISTER << 8) | (REG_02 << 2), 2, buffer, sizeof(buffer), HAL_MAX_DELAY);
...
void set_resolution_X(uint8_t res)					// set resolution of X axis
{
	...
	{
		HAL_I2C_Master_Transmit(&hi2c2, MLX90393_ADDR, data_from_master, 4, HAL_MAX_DELAY);
	}
}
...
uint8_t get_gain(void)
{
	uint8_t buffer[3];
	uint16_t value;
	HAL_I2C_Mem_Read(&hi2c2, MLX90393_ADDR, (CMD_READ_REGISTER << 8) | (REG_00 << 2), 2, buffer, sizeof(buffer), HAL_MAX_DELAY);
	HAL_I2C_Mem_Read(&hi2c2, MLX90393_ADDR, (CMD_READ_REGISTER << 8) | (REG_00 << 2), 2, buffer, sizeof(buffer), HAL_MAX_DELAY);
	HAL_I2C_Mem_Read(&hi2c2, MLX90393_ADDR, (CMD_READ_REGISTER << 8) | (REG_00 << 2), 2, buffer, sizeof(buffer), HAL_MAX_DELAY);
	HAL_I2C_Mem_Read(&hi2c2, MLX90393_ADDR, (CMD_READ_REGISTER << 8) | (REG_00 << 2), 2, buffer, sizeof(buffer), HAL_MAX_DELAY);
...
uint16_t read_register(uint8_t reg)
{
	uint8_t buffer[3];
	uint16_t value;
	HAL_I2C_Mem_Read(&hi2c2, MLX90393_ADDR, (CMD_READ_REGISTER << 8) | (reg << 2), 2, buffer, sizeof(buffer), HAL_MAX_DELAY);
	value = buffer[2] | (buffer[1] << 8);
	return value;
}
...
uint8_t get_tcmp_en(void)
{
	uint8_t buffer[3];
	uint16_t value;
	HAL_I2C_Mem_Read(&hi2c2, MLX90393_ADDR, (CMD_READ_REGISTER << 8) | (REG_01 << 2), 2, buffer, sizeof(buffer), HAL_MAX_DELAY);
	value = buffer[2] | (buffer[1] << 8);
...
uint8_t get_sens_tc_lt(void)
{
	uint8_t buffer[3];
	uint16_t value;
	HAL_I2C_Mem_Read(&hi2c2, MLX90393_ADDR, (CMD_READ_REGISTER << 8) | (REG_03 << 2), 2, buffer, sizeof(buffer), HAL_MAX_DELAY);
	value = buffer[2] | (buffer[1] << 8);
...
uint16_t get_offset_X(void)
{
	uint8_t buffer[3];
	uint16_t value;
	HAL_I2C_Mem_Read(&hi2c2, MLX90393_ADDR, (CMD_READ_REGISTER << 8) | (REG_04 << 2), 2, buffer, sizeof(buffer), HAL_MAX_DELAY);
	HAL_I2C_Mem_Read(&hi2c2, MLX90393_ADDR, (CMD_READ_REGISTER << 8) | (REG_04 << 2), 2, buffer, sizeof(buffer), HAL_MAX_DELAY);
	HAL_I2C_Mem_Read(&hi2c2, MLX90393_ADDR, (CMD_READ_REGISTER << 8) | (REG_04 << 2), 2, buffer, sizeof(buffer), HAL_MAX_DELAY);
...
uint16_t get_offset_Y(void)
{
	uint8_t buffer[3];
	uint16_t value;
	HAL_I2C_Mem_Read(&hi2c2, MLX90393_ADDR, (CMD_READ_REGISTER << 8) | (REG_05 << 2), 2, buffer, sizeof(buffer), HAL_MAX_DELAY);
	HAL_I2C_Mem_Read(&hi2c2, MLX90393_ADDR, (CMD_READ_REGISTER << 8) | (REG_05 << 2), 2, buffer, sizeof(buffer), HAL_MAX_DELAY);
	value = buffer[2] | (buffer[1] << 8);
...
uint16_t get_offset_Z(void)
{
	uint8_t buffer[3];
	uint16_t value;
	HAL_I2C_Mem_Read(&hi2c2, MLX90393_ADDR, (CMD_READ_REGISTER << 8) | (REG_06 << 2), 2, buffer, sizeof(buffer), HAL_MAX_DELAY);
	HAL_I2C_Mem_Read(&hi2c2, MLX90393_ADDR, (CMD_READ_REGISTER << 8) | (REG_06 << 2), 2, buffer, sizeof(buffer), HAL_MAX_DELAY);
	value = buffer[2] | (buffer[1] << 8);
...
{
	HAL_I2C_Mem_Read(&hi2c2, MLX90393_ADDR, CMD_MEM_STORE, 1, buffer, 1, HAL_MAX_DELAY);
...
{
	HAL_I2C_Mem_Read(&hi2c2, MLX90393_ADDR, CMD_MEM_RECALL, 1, buffer, 1, HAL_MAX_DELAY);
